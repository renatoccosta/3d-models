...
pcbWidth            = 93; // side to side (Y axis)
pcbThickness        = 1.7; 
standoffHeight      = 6; //-- How much the PCB needs to be raised from the base to leave room for solderings and whatnot
standoffDiameter    = 7;
...
pcbStands = 
[
    [standoffDiameter/2,standoffDiameter/2, yappBaseOnly, yappHole],
    [standoffDiameter/2+80,standoffDiameter/2, yappBaseOnly, yappHole],
    [standoffDiameter/2,standoffDiameter/2+86, yappBaseOnly, yappHole],
    [standoffDiameter/2+80,standoffDiameter/2+86, yappBaseOnly, yappHole],
    [pcbLength-(standoffDiameter/2),standoffDiameter/2, yappBaseOnly, yappHole],
    [pcbLength-(standoffDiameter/2),standoffDiameter/2+59, yappBaseOnly, yappHole]
];
...
cutoutsRight =  
[
    [(pcbLength-paddingBack)/2,0,43,14,0,yappRectangle,yappCenter]
];
...
snapJoins   =   
[
    [(pcbWidth+paddingLeft+paddingRight)/2,10,yappFront,yappBack,yappCenter],
    [(pcbLength+paddingBack+paddingFront)/2,10,yappLeft,yappCenter]    
];
...
lightTubes =
[
    [paddingBack+1,paddingLeft+44,7,7,1,2,yappRectangle,0.5]
];
...
pushButtons = 
[
    [33,pcbWidth-6,5,5,0,2,2,1,3,yappRectangle]
];
...
labelsPlane =
[
    [_labelsPosX-(cutoutsRight[0][2]/5)*0,20,90,1,yappRight,"Liberation Mono:style=bold",2,"Lin"],
    [_labelsPosX-(cutoutsRight[0][2]/5)*1,20,90,1,yappRight,"Liberation Mono:style=bold",2,"Nin"],
    [_labelsPosX-(cutoutsRight[0][2]/5)*2,20,90,1,yappRight,"Liberation Mono:style=bold",2,"Nout"],
    [_labelsPosX-(cutoutsRight[0][2]/5)*3,20,90,1,yappRight,"Liberation Mono:style=bold",2,"L1out"],
    [_labelsPosX-(cutoutsRight[0][2]/5)*4,20,90,1,yappRight,"Liberation Mono:style=bold",2,"L2out"],
];

imagesPlane =
[
  [ (pcbLength+paddingBack+paddingFront)/2, (pcbWidth+paddingLeft+paddingRight)/2, -180, 2, yappLid, "ha-logo.svg", .7 ]
];
